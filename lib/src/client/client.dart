...
abstract class Client extends ClientBase {
  core.String basePath = "/language/translate/";
  ...
  DetectionsResource_ get detections => new DetectionsResource_(this);
  LanguagesResource_ get languages => new LanguagesResource_(this);
  TranslationsResource_ get translations => new TranslationsResource_(this);
